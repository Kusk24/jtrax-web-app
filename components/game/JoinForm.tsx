    ...
    <form onSubmit={submit} className="flex flex-col gap-3.5">
      <Panel>
        ...
        <input
          ...
          placeholder="ABC123"
          className="w-full rounded-xl border-none bg-sv-paper px-3 py-3 text-center font-mono text-[26px] font-bold tracking-[0.35em] text-sv-brown shadow-[inset_0_0_0_1.5px_rgba(208,158,97,0.6)] outline-none placeholder:opacity-30 focus:shadow-[inset_0_0_0_2px_rgb(192,120,98)]"
        />
